...
type SecurityServiceClient interface {
	CreateUser(ctx context.Context, in *UserCredentials, opts ...grpc.CallOption) (*ResponseMessage, error)
...
func (c *securityServiceClient) CreateUser(ctx context.Context, in *UserCredentials, opts ...grpc.CallOption) (*ResponseMessage, error) {
	out := new(ResponseMessage)
	err := c.cc.Invoke(ctx, "/proto.SecurityService/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SecurityServiceServer interface {
	CreateUser(context.Context, *UserCredentials) (*ResponseMessage, error)
...
func (UnimplementedSecurityServiceServer) CreateUser(context.Context, *UserCredentials) (*ResponseMessage, error) {
...
func _SecurityService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserCredentials)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecurityServiceServer).CreateUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.SecurityService/CreateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecurityServiceServer).CreateUser(ctx, req.(*UserCredentials))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SecurityService_CreateUser_Handler,
		},
		{
			MethodName: "Login",
